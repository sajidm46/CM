...
namespace CampaignManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/AddCustomerDetails
        [AllowAnonymous]
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> AddCustomerDetails(CustomerDetails model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            model.lastupd = DateTime.Now;

            using (var unitOfWork = new UnitOfWork())
            {
                unitOfWork.CustomerDetailsRepository.Add(model);
             }
